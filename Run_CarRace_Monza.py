...
from RenderVideo_Monza import show_animi
...
model_path = resolve_model_path(MODEL_PATH, prefixes=('monza_gt3_model_',))
...
print(f'Running Monza evaluation with {model_path}')
...
if RENDER_VIDEO:
    show_animi(env, logger, step, save=True, path='results/Monza_Video.mp4')
