...
TRACK_SELECT = 'monza'   # 'simple' | 'monza'
...
for episode in range(10000):
    ...
    for step in range(10000):
        ...
        if stepcounter < args['start_timesteps']:
            ...
            # Decay expl_noise from original to 0.02 over 1M steps
            current_noise = max(0.02, args['expl_noise'] - (args['expl_noise'] - 0.02) * (stepcounter / 1000000.0))
            noise  = np.random.normal(0, max_action * current_noise, size=action_dim)
